...
# ===========search-criteria naming linkage==============
year_min = search_criteria[0]
engine_vol_min = search_criteria[1]
price_max = search_criteria[2]

# ============filter-result entity creation======================
filter_result =  []

# ============initial-data naming linkage================
...
# ============filtering procedure==================================
    if (    year >= year_min              # Question for teacher: is it a good practice to add tab at the start of such conditions-list?
        and engine_vol >= engine_vol_min    # another one: is it a good practice to make it as a multirow list instead of single-line?
        and price <= price_max
    ):
        filter_result.append((name, year, engine_vol, body, price))

# test1
# print(filter_result)

# ============filter result sorting================================
sort_result = sorted(filter_result, key = lambda pr: pr[4], reverse = False)

# test2
# print(sort_result)

# ============searched output for user=============================
ui_output = sort_result[:5]
# print(ui_output)

# =============out of scope========================================
for car in ui_output:
    print(car)                            # prints result in multirow readable view
