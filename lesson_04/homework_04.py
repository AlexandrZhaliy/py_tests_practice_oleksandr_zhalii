...
h_letter_counter = adventures_of_tom_sawer.count("h")
# test4
# print(h_letter_counter)
...
"""
# =========the first way==========
second_tom = adventures_of_tom_sawer.find("Tom", + 1)
# test-6a
# print(second_tom)

# =========the second way==========
first_tom = adventures_of_tom_sawer.find("Tom")
second_tom = adventures_of_tom_sawer.find("Tom", first_tom + 1)
# test-6b
# print(first_tom)
# print(second_tom)
...
last_sentence_words_counter = len(adventures_of_tom_sawer_sentences[-1].split())
print(last_sentence_words_counter)
